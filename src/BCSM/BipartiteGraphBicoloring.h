	...
	*/
	...
	public:
		...
		double GetVertexColoringTime();
                ...
                // Xin
                // DMD Star BiColoring
		int DMDCoveringStarBicoloring(int& nColors, vector<int>& vColors_L, vector<int>& vColors_R, DMDecomposition const& DMD, int const nVerbose=0, chrono::duration<double>* pT=nullptr); 
                //int DMDCoveringStarBicoloring(string const &DMDFileName, int& nC, int nVerbose);
                // // Read DMD vertex Cover
                // void DMDCoverVertex( 
